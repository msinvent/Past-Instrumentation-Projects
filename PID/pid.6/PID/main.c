...
void __attribute__ ((__interrupt__,__no_auto_psv__)) _T1Interrupt(void)
{
	...
	//CONTROL_1(adc_value_setpoint, adc_value_present);//my_error_correction
	//CONTROL_2(adc_value_setpoint, adc_value_present);//P
	//CONTROL_3(adc_value_setpoint, adc_value_present);//P(-I) ?? :)
	//CONTROL_3_2(adc_value_setpoint, adc_value_present); //PI controller
	CONTROL_4(adc_value_setpoint, adc_value_present);//PD controller
