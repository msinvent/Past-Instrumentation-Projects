...
while 1:
    ...
    if len(IMU_raw) ==13 :
        counter += 1;
        t=time.time();
        Kacc[0]=-int16((ord(IMU_raw[7])<<8)+ord(IMU_raw[6]))*0.001;
        Kacc[1]=-int16((ord(IMU_raw[9])<<8)+ord(IMU_raw[8]))*0.001;
        Kacc[2]=-int16((ord(IMU_raw[11])<<8)+ord(IMU_raw[10]))*0.001;
        w[0]=int16((ord(IMU_raw[1])<<8)+ord(IMU_raw[0]))*8.72664e-4;
        w[1]=int16((ord(IMU_raw[3])<<8)+ord(IMU_raw[2]))*8.72664e-4;
        w[2]=int16((ord(IMU_raw[5])<<8)+ord(IMU_raw[4]))*8.72664e-4;
        t=time.time();
        #Kacc= [1,0,0]    
        ...
        #print 'Before wA ::',wA[0],wA[1],wA[2]
