...
while 1:
    ...
    #    w[0]=-((int16((ord(IMU_raw[1])<<8)+ord(IMU_raw[0]))*8.73e-4) - 0.01);
    #    w[1]=-((int16((ord(IMU_raw[3])<<8)+ord(IMU_raw[2]))*8.73e-4) + 0.01);
    #    w[2]=-((int16((ord(IMU_raw[5])<<8)+ord(IMU_raw[4]))*8.73e-4) + 0.01);
        ...
        if counter %8 == 0:
            v=dcm_transform(dcmGyro,(2,0,0));
            IMU_front.pos=(v[0],v[2],-v[1])
            v=dcm_transform(dcmGyro,(-2,0,0));
            IMU_back.pos=(v[0],v[2],-v[1])
            v=dcm_transform(dcmGyro,(0,-2,0));
            IMU_right.pos=(v[0],v[2],-v[1])
            v=dcm_transform(dcmGyro,(0,+2,0));
            IMU_left.pos=(v[0],v[2],-v[1])
